...
export default class Pushy {
  constructor(options = {}) {
    ...
    this._config = {
      ...
      log: true,
      // 开始检查更新提示
      startGetUpdateTips: '开始检查更新...',
      // 正在检查更新提示
      gettingUpdateTips: '正在检查更新中...',
    }
  ...
  async getUpdate() {
    ...
    // 判断是否正在静默更新
    if (this.state.isSlientUpdating) {
      return Promise.resolve({
        statusCode: 454,
        message: '正在静默更新',
      })
